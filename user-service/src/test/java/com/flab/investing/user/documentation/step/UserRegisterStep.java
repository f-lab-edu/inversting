...
public class UserRegisterStep {
    ...
    public static RestDocumentationFilter userRegisterDocumentationFilter(String identifier) {
    ...
    private static RequestFieldsSnippet requestFieldsSnippet() {
        return requestFields(
                ...
                fieldWithPath("confirmPassword").type(JsonFieldType.STRING).description("비밀번호확인"),
